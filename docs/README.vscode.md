...
- 写代码 → 先选验证预算和测试策略（.github/superpowers/testing-policy/SKILL.md），高风险变更再 TDD（.github/superpowers/test-driven-development/SKILL.md）
...
其他方法论类 skills（头脑风暴、测试策略、TDD、调试、代码审查等）完全兼容。
