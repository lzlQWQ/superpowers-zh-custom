...
description: 当实现完成、计划要求的验证证据已通过、需要决定如何集成工作时使用——通过提供合并、PR 或清理等结构化选项来引导开发工作的收尾
version: "1.0.0"
license: MIT
metadata:
  hermes:
...
**在展示选项之前，按 `superpowers:testing-policy` 和计划检查点验证证据通过：**
