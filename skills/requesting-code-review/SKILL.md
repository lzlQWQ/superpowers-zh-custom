...
description: 完成高风险任务、实现重要功能、到达计划检查点或合并前使用，用于验证工作成果是否符合要求
version: "1.0.0"
license: MIT
metadata:
  hermes:
...
**核心原则：** 在风险边界和自然检查点审查，避免低风险小任务过度打断。

## 何时请求审查

**必须审查：**
- 子代理驱动开发中的高风险任务完成后，或到达计划定义的自然检查点后
- 完成重要功能后
- 合并到 main 之前
...
**子代理驱动开发：**
- 高风险任务完成后审查
- 低风险小任务可在自然 checkpoint 合并审查
- 在问题叠加之前发现它们
- 修复后再进入下一个任务

**执行计划：**
- 高风险任务完成后或在自然 checkpoint 审查
- 获取反馈，应用，继续
