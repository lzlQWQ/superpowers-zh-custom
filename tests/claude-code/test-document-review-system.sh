...
mkdir -p docs/superpowers/2026-07-09-test-feature/specs

# Create a spec document WITH INTENTIONAL ERRORS for the reviewer to catch
cat > docs/superpowers/2026-07-09-test-feature/specs/test-feature-design.md <<'EOF'
# Test Feature Design
...
Then review the spec at $TEST_PROJECT/docs/superpowers/2026-07-09-test-feature/specs/test-feature-design.md using the criteria from that template.
